...
Configurable interactive environments, AI assistance, human interfaces, and synchronized data collection — built on [MiniGrid](https://github.com/Farama-Foundation/Minigrid).
...
::: {.punchline}
Most testbeds manage two of these. MOSAIC is our attempt at [all four at once]{.accent}.
:::

---

## The [Search-and-Rescue]{.accent} Scenario

::: {.annotated}
![](assets/gui-screenshot.png){height="470"}

::: {.anno .fragment style="--x:34%; --y:11%; --w:6%; --h:8%;"}
You — one operator, a building of rooms
:::

::: {.anno .fragment .below style="--x:14%; --y:72%; --w:5%; --h:8%; --ly:8px;"}
Victims — and lookalike decoys
:::

::: {.anno .fragment style="--x:26%; --y:60%; --w:21%; --h:21%;"}
Lava — instant mission failure
:::

::: {.anno .fragment style="--x:60%; --y:59%; --w:8%; --h:12%; --lx:-90px; --ly:-34px;"}
Locked door — bring a key
:::

::: {.anno .fragment .below style="--x:67%; --y:0%; --w:32%; --h:26%;"}
...
::: {.punchline}
Navigate, search, discriminate, and finish before the clock or the survivors [run out]{.accent}.
:::
...
::: {.punchline}
Almost everything worth measuring lives in the gap between [step 3 and step 4]{.accent}.
:::

---

## The Main [Parts]{.accent} of MOSAIC
...
::: {.punchline}
Now that we understand the platform, let's [install it]{.accent} and run our first mission.
:::
